...
func createYAML(ctx *context.Context, winget config.Winget, in any, tp artifact.Type) error {
	...
	filename := winget.PackageIdentifier + extFor(tp, winget.DefaultLocale)
...
const (
	...
	versionLangServer       = "# yaml-language-server: $schema=https://aka.ms/winget-manifest.version.1.12.0.schema.json"
	installerLangServer     = "# yaml-language-server: $schema=https://aka.ms/winget-manifest.installer.1.12.0.schema.json"
	defaultLocaleLangServer = "# yaml-language-server: $schema=https://aka.ms/winget-manifest.defaultLocale.1.12.0.schema.json"
	defaultLocale           = "en-US"
